...
export type tt_access_logOptionalAttributes = "USER_ID" | "IPv4" | "IPv6";
...
export class tt_access_log extends Model<tt_access_logAttributes, tt_access_logCreationAttributes> implements tt_access_logAttributes {
  ...
  // tt_access_log belongsTo tt_api_list via API_ID
  API!: tt_api_list;
  getAPI!: Sequelize.BelongsToGetAssociationMixin<tt_api_list>;
  setAPI!: Sequelize.BelongsToSetAssociationMixin<tt_api_list, tt_api_listId>;
  createAPI!: Sequelize.BelongsToCreateAssociationMixin<tt_api_list>;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof tt_access_log {
    ...
    indexes: [
      ...
      {
        name: "FK_tt_access_log_API_ID_tt_api_list_API_ID",
        using: "BTREE",
        fields: [
          { name: "API_ID" },
        ]
