...
import {
  tt_file_download_log as _tt_file_download_log,
} from "./tt_file_download_log";
import type {
...
import {
  tt_product_category as _tt_product_category,
} from "./tt_product_category";
import type {
  tt_product_imageAttributes,
  tt_product_imageCreationAttributes,
} from "./tt_product_image";
...
import {
  tt_product_trade_log as _tt_product_trade_log,
} from "./tt_product_trade_log";
import type {
...
import {
  tt_product_update_log as _tt_product_update_log,
} from "./tt_product_update_log";
import type {
...
export function initModels(sequelize: Sequelize) {
  ...
  tt_notice_image.belongsTo(tt_content, {
    as: "CONTENT",
    foreignKey: "CONTENT_ID",
  });
  tt_content.hasMany(tt_notice_image, {
    as: "tt_notice_images",
    foreignKey: "CONTENT_ID",
  });
  tt_product_image.belongsTo(tt_content, {
    as: "CONTENT",
    foreignKey: "CONTENT_ID",
  });
  tt_content.hasMany(tt_product_image, {
    as: "tt_product_images",
    foreignKey: "CONTENT_ID",
  });
  tt_view_log.belongsTo(tt_content, {as: "CONTENT", foreignKey: "CONTENT_ID"});
  tt_content.hasMany(tt_view_log, {
    as: "tt_view_logs",
    foreignKey: "CONTENT_ID",
  });
  tt_file_download_log.belongsTo(tt_file, {as: "FILE", foreignKey: "FILE_ID"});
  tt_file.hasMany(tt_file_download_log, {
    as: "tt_file_download_logs",
    foreignKey: "FILE_ID",
  });
  tt_notice_image.belongsTo(tt_file, {as: "FILE", foreignKey: "FILE_ID"});
  tt_file.hasMany(tt_notice_image, {
    as: "tt_notice_images",
    foreignKey: "FILE_ID",
  });
  tt_product_image.belongsTo(tt_file, {as: "FILE", foreignKey: "FILE_ID"});
  tt_file.hasMany(tt_product_image, {
    as: "tt_product_images",
    foreignKey: "FILE_ID",
  });
  tt_notice.belongsTo(tt_notice_master, {
    as: "NOTICE_MASTER",
    foreignKey: "NOTICE_MASTER_ID",
  });
  tt_notice_master.hasMany(tt_notice, {
    as: "tt_notices",
    foreignKey: "NOTICE_MASTER_ID",
  });
  tt_product_trade_log.belongsTo(tt_product, {
    as: "PRODUCT",
    foreignKey: "PRODUCT_ID",
  });
  tt_product.hasMany(tt_product_trade_log, {
    as: "tt_product_trade_logs",
    foreignKey: "PRODUCT_ID",
  });
  tt_product_update_log.belongsTo(tt_product, {
    as: "PRODUCT",
    foreignKey: "PRODUCT_ID",
  });
  tt_product.hasMany(tt_product_update_log, {
    as: "tt_product_update_logs",
    foreignKey: "PRODUCT_ID",
  });
  tt_product.belongsTo(tt_product_category, {
    as: "PRODUCT_CATEGORY",
    foreignKey: "PRODUCT_CATEGORY_ID",
  });
  tt_product_category.hasMany(tt_product, {
    as: "tt_products",
    foreignKey: "PRODUCT_CATEGORY_ID",
  });
  tt_product_image.belongsTo(tt_product_update_log, {
    as: "PRODUCT",
    foreignKey: "PRODUCT_ID",
  });
  tt_product_update_log.hasMany(tt_product_image, {
    as: "tt_product_images",
    foreignKey: "PRODUCT_ID",
  });
  ...
  tt_user.hasMany(tt_file_download_log, {
    as: "tt_file_download_logs",
    foreignKey: "USER_ID",
  });
  ...
  tt_user.hasMany(tt_nickname_log, {
    as: "tt_nickname_logs",
    foreignKey: "USER_ID",
  });
  ...
  tt_notice.belongsTo(tt_user, {
    as: "UPDATE_USER",
    foreignKey: "UPDATE_USER_ID",
  });
  tt_user.hasMany(tt_notice, {
    as: "UPDATE_USER_tt_notices",
    foreignKey: "UPDATE_USER_ID",
  });
  tt_notice_master.belongsTo(tt_user, {
    as: "CREATE_USER",
    foreignKey: "CREATE_USER_ID",
  });
  tt_user.hasMany(tt_notice_master, {
    as: "tt_notice_masters",
    foreignKey: "CREATE_USER_ID",
  });
  tt_notice_master.belongsTo(tt_user, {
    as: "UPDATE_USER",
  ...
  tt_user.hasMany(tt_notice_master, {
    as: "UPDATE_USER_tt_notice_masters",
    foreignKey: "UPDATE_USER_ID",
  });
  tt_product.belongsTo(tt_user, {
    as: "SELLER_USER",
    foreignKey: "SELLER_USER_ID",
  });
  tt_user.hasMany(tt_product, {
    as: "tt_products",
    foreignKey: "SELLER_USER_ID",
  });
  tt_product_category.belongsTo(tt_user, {
    as: "UPDATE_USER",
    foreignKey: "UPDATE_USER_ID",
  });
  tt_user.hasMany(tt_product_category, {
    as: "tt_product_categories",
    foreignKey: "UPDATE_USER_ID",
  });
  tt_product_category.belongsTo(tt_user, {
    as: "CREATE_USER",
  ...
  tt_user.hasMany(tt_product_category, {
    as: "CREATE_USER_tt_product_categories",
    foreignKey: "CREATE_USER_ID",
  });
  tt_product_trade_log.belongsTo(tt_user, {
    as: "SELLER_USER",
    foreignKey: "SELLER_USER_ID",
  });
  tt_user.hasMany(tt_product_trade_log, {
    as: "tt_product_trade_logs",
    foreignKey: "SELLER_USER_ID",
  });
  tt_product_trade_log.belongsTo(tt_user, {
